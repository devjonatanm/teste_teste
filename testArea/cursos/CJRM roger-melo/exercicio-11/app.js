...
//console.log(age(28))
//console.log(idade) // POR QUE LET SÓ É ACESIVEL DENTRO DO ESCOPO, ESTA PRIVADO PARA SOMENTE ESCOPO DA DETERMINA FUNÇÃO
...
const car = {
  ...
  getColorsMessage: function () { return `O ${this.name} está disponível nas cores ${this.colors[0]}, ${this.colors[1]} e ${this.colors[2]}` },
}
