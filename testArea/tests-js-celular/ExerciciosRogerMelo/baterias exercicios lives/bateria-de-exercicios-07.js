//https://github.com/Roger-Melo/exercicios-js-do-zero/blob/main/bateria-de-exercicios-07/app.js
...
//posso utilizar split() e join() ou somente replace()
//CORREÇÃO prof usou raplace palavra serto por certo, pos tudo numa linha
...
const multiplicar = (a, b, c) => [a, b, c].includes(undefined) ? 'Insira todos os argumentos!' : a * b * c // corrigido
...
const somar = (arg1, arg2, arg3) => {
    ...
    const temNenhumArg = [arg1, arg2, arg3].every(eUndefined) // corrigido pelo prof
...
const dobrar = numeros => { // professor usou forEach
...
/* const saoMesmaVersao = obj => {
    ...
    return obj.versoes.every(x => x == versaoOficial)
} */
const saoMesmaVersao = obj => obj.versoes.every(x => x == versaoOficial)
...
const todosTemJs = arquivos.every(x => x.includes('js'))
//console.log(todosTemJs)
